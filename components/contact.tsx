...
export default function Contact () {
    return (
        <section id="contact" className="bg-teal-500 min-h-screen font-sans">
          <div>
            <h1 className="text-5xl text-center md:text-left md:text-8xl text-orange-600 font-extrabold px-20 md:px-40 pt-24 font-serif">Want me to make your dream website come true?</h1>
          ...
          <div className="pb-5 md:shadow-none md:bg-opacity-0 font-sans bg-teal-600 rounded-xl px-5 shadow-md shadow-black my-10 mx-auto">
