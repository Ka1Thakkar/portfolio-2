...
export default function Home() {
    return (
        <section id="home" className='text-center bg-gray-500 bg-opacity-50 shadow-lg p-10 shadow-black rounded-xl'>
            ...
            <a href="https://drive.google.com/file/d/1t3B7eNAgkZ4LuSw7r3FQMYaIQPbg73XO/view?usp=sharing" target="_blank" rel="noopener noreferrer" ><button className=" bg-gradient-to-b from-orange-600 to-orange-400 py-1 px-5 rounded-lg text-xl font-bold mt-3 font-mono hover:shadow-md hover:shadow-black hover:bg-gradient-to-t hover:from-orange-600 hover:to-orange-400 shadow-black shadow-md text-black">Resume</button></a>
        </section>
    )
}