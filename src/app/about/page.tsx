    ...
    return (
      <AnimatePresence>
        ...
        id="about" className=" 2xl:pt-10 2xl:pb-32 bg-gradient-to-b from-black via-gray-900 to-sky-900/70 justify-center px-10 pt-10 min-h-screen">
          ...
          transition={{duration:1}}
          className='text-5xl 2xl:text-6xl text-white underline decoration-4 underline-offset-8 decoration-red-600 text-left pb-12 lg:px-20 xl:px-40 2xl:px-80'>About Me</motion.h1>
